...
export function buildContext(experiments: ExperimentMeta[], summary: ExpCSummary | null): string {
  let s =
    ...
    'Break-even reads R* = (N·c_c + W·c_m)/(c_q − c_r). Answer in 2–5 sentences, plainly.\n\n'
